...
docker-machine ssh docker-master sudo sysctl -w vm.max_map_count=1048575
...
docker-machine ssh docker-master sudo 'sed -i -e "\$a sysctl -w vm.max_map_count=1048575" /var/lib/boot2docker/profile'
...
docker-machine scp daemon-jsonfile.json docker-master:
...
docker-machine ssh docker-master sudo mv daemon-jsonfile.json /etc/docker
...
docker-machine ssh docker-master sudo cat /etc/docker/daemon-jsonfile.json
