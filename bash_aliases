...
alias tf_plan='terraform plan -input=false -out=ftplan -var-file=../../config/config.tfvars -var-file=../../config/other.tfvars -var-file=../../config/network.tfvars -var-file=../../config/consul.tfvars -var-file=../../config/version.tfvars'
alias tf_apply='terraform apply -input=false ftplan'
